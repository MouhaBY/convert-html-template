...
export default function Contact() {
    ...
    <>
        <Nav />
        <Header imgName="contact-bg" title="Contact Me" subtitle="Have questions? I have answers."/>
        <main className="mb-4">
                    ...
                    <div className="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div className="my-5">
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div className="form-floating">
                                    <textarea className="form-control" id="message" placeholder="Enter your message here..." style={{height: 100}} data-sb-validations="required"></textarea>
